...
export function CartBar({ cart, cartTotal, onHold, onRecall, onClear, onCheckout, isDark, text, textMuted, border, orange, card }: Props) {
  ...
  const recallBtn = { ...btnBase, backgroundColor: isDark ? '#334155' : card }
  ...
  return (
    <View style={{ borderTopWidth: 1, borderTopColor: border, backgroundColor: card, padding: 12 }}>
