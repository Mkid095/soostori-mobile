// Styles for UnitPickerModal
import { StyleSheet } from 'react-native'

export const unitPickerStyles = StyleSheet.create({
  backdrop: {
  ...
  itemText: { flex: 1, fontSize: 15, color: '#0f172a', fontWeight: '500', textTransform: 'capitalize' },
